...
trained by skin_train_v5.py.

This script follows the infer_inhouse.py workflow, but loads the
V2/V5 model architecture from skin_net_v2.py.
"""
...
def load_model_v5(checkpoint_path: str, device: torch.device):
    """Load a SkinAnalyzerV2 checkpoint trained by skin_train_v2/v3/v4/v5."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description='In-house full inference for skin_train_v5 checkpoints',
...
def main() -> None:
    ...
    print("Loading v5-compatible model checkpoint...")
    model, cfg = load_model_v5(args.checkpoint, device)
